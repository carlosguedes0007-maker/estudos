...
```html
<!-- Meu Experimento Prático: Módulo 1: Fundamentos, Tags Essenciais e Semântica (Tópicos 01 a 10) | Estudante: Carlos Guedes -->
<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
    <title>Meu Lab HTML5 - Modulo_01_Iniciante_Fundamentos | Carlos Guedes</title>
</head>
<body>
    <header>
        <h1>Anotações & Experimentos HTML5 - Módulo 1: Fundamentos, Tags Essenciais e Semântica (Tópicos 01 a 10)</h1>
    </header>
    <main>
        <section>
