...
```html
<!-- Meu Experimento Prático: Módulo 2: Formulários Avançados, Validações e Interatividade (Tópicos 11 a 20) | Estudante: Carlos Guedes -->
<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
    <title>Meu Lab HTML5 - Modulo_02_Formularios_e_Interatividade | Carlos Guedes</title>
</head>
<body>
    <header>
        <h1>Anotações & Experimentos HTML5 - Módulo 2: Formulários Avançados, Validações e Interatividade (Tópicos 11 a 20)</h1>
    </header>
    <main>
        <section>
