...
```html
<!-- Meu Experimento Prático: Módulo 3: Multimídia, Áudio, Vídeo, Canvas e Gráficos SVG (Tópicos 21 a 30) | Estudante: Carlos Guedes -->
<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
    <title>Meu Lab HTML5 - Modulo_03_Multimidia_e_Graficos | Carlos Guedes</title>
</head>
<body>
    <header>
        <h1>Anotações & Experimentos HTML5 - Módulo 3: Multimídia, Áudio, Vídeo, Canvas e Gráficos SVG (Tópicos 21 a 30)</h1>
    </header>
    <main>
        <section>
