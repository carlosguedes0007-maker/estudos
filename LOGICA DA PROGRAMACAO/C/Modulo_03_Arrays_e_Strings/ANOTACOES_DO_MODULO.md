...
```c
/* Meu Experimento em Linguagem C: Módulo 3: Vetores, Matrizes e Manipulação de Strings Nativas (Tópicos 21 a 30) | Estudante: Carlos Guedes */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(void) {
    printf("=====================================================
");
    printf("📓 Meu Caderno de C - Modulo_03_Arrays_e_Strings
");
