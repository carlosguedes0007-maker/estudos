...
```c
/* Meu Experimento em Linguagem C: Módulo 6: Estruturas de Dados Avançadas em C Puro (Tópicos 51 a 60) | Estudante: Carlos Guedes */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main(void) {
    printf("=====================================================
");
    printf(" Meu Caderno de C - Modulo_06_Estruturas_de_Dados_em_C
");
