...
```javascript
// Meu Experimento JS: Módulo 2: Funções, Escopo, Closures e Programação Funcional (Tópicos 11 a 20) | Estudante: Carlos Guedes
...
const lab = new MeuCadernoJS("Módulo 2: Funções, Escopo, Closures e Programação Funcional (Tópicos 11 a 20)");
