...
```javascript
// Meu Experimento JS: Módulo 5: Assincronismo, Promises, Fetch API e Async/Await (Tópicos 41 a 50) | Estudante: Carlos Guedes
...
const lab = new MeuCadernoJS("Módulo 5: Assincronismo, Promises, Fetch API e Async/Await (Tópicos 41 a 50)");
