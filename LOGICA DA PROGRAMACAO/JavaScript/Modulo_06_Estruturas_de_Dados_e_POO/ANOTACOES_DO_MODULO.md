...
```javascript
// Meu Experimento JS: Módulo 6: Orientação a Objetos, Estruturas de Dados e Módulos (Tópicos 51 a 60) | Estudante: Carlos Guedes
...
const lab = new MeuCadernoJS("Módulo 6: Orientação a Objetos, Estruturas de Dados e Módulos (Tópicos 51 a 60)");
