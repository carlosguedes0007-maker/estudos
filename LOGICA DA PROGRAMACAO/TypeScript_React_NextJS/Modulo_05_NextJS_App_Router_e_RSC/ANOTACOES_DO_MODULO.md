...
```typescript
// Meu Experimento TypeScript / React: Módulo 5: Next.js App Router, React Server Components (RSC) e SSR (Tópicos 41 a 50) | Estudante: Carlos Guedes
