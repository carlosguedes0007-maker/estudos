# -*- coding: utf-8 -*-
"""
Script de Aprimoramento de Aulas Legadas (Upgrade Legacy Files)
Melhora todas as aulas que já existiam no repositório Estudos, adicionando design premium,
explicações detalhadas, boas práticas e formatação limpa.
"""
...
HTML_UPGRADES = {
    "aula1 (COMEÇANDO html).html": """<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Aula 01 - Começando com HTML5 | Carlos Guedes</title>
    <style>
...
<body>
    <header class="header">
        <h1>Aula 01: Estrutura Básica e Títulos (H1 ao H6)</h1>
        <p>Desenvolvido por <span class="highlight">Carlos Guedes</span> no Ecossistema de Estudos.</p>
    </header>
    
    <main>
        <div class="conceito">
            <h2>🧠 Por que usamos títulos no HTML5?</h2>
            <p>Os elementos <strong>&lt;h1&gt;</strong> a <strong>&lt;h6&gt;</strong> definem a hierarquia semântica da informação. Os motores de busca (como o Google) e os leitores de tela para deficientes visuais utilizam esses títulos para compreender a estrutura de tópicos da página.</p>
        </div>
    ...
    "aula2 (textos ).html": """<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
    <title>Aula 02 - Formatação de Textos | Carlos Guedes</title>
    <style>
...
<body>
    <h1>Aula 02: Parágrafos e Formatação Semântica de Texto</h1>
    <div class="box">
        <p>No HTML5 moderno, evite tags antigas como &lt;b&gt; e &lt;i&gt;. Utilize:</p>
        <ul>
    ...
    "aula3 (imagens).html": """<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
    <title>Aula 03 - Imagens e Acessibilidade | Carlos Guedes</title>
    <style>
...
<body>
    <h1>Aula 03: Inserção de Imagens, Atributo ALT e Tag Figure</h1>
    <p>A tag <strong>&lt;figure&gt;</strong> encapsula uma mídia e sua legenda <strong>&lt;figcaption&gt;</strong>, criando uma estrutura semântica perfeita para artigos técnicos:</p>
    <figure>
        ...
        <figcaption>Figura 3.1: Ambiente de desenvolvimento otimizado de Carlos Guedes.</figcaption>
    </figure>
</body>
</html>"""
}
...
CSS_UPGRADES = {
    "aula1 (começando com o CSS).html": """<!DOCTYPE html>
<html lang="pt-br">
<head>
    <meta charset="UTF-8">
    <title>Aula 01 - Introdução ao CSS3 | Carlos Guedes</title>
    <style>
...
<body>
    <div class="hero">
        ...
        <p>Bem-vindo ao laboratório de estilização de <strong>Carlos Guedes</strong>. Aqui exploramos variáveis, box model e design interativo!</p>
    </div>
</body>
</html>"""
}
...
def upgrade_legacy():
    print("[UPGRADE] Aprimorando aulas legadas no diretório HTML...")
    ...
    for fname, content in HTML_UPGRADES.items():
        ...
        if os.path.exists(fpath):
            with open(fpath, "w", encoding="utf-8") as f:
                f.write(content)
            print(f" -> Atualizado com design premium: {fname}")

    print("[UPGRADE] Aprimorando aulas legadas no diretório CSS...")
    ...
    print("[SUCESSO] Upgrade das aulas legadas finalizado!")
